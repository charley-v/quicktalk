import { AmplifyResourceGroupName, BackendSecret, ConstructFactory, FunctionResources, ResourceAccessAcceptorFactory, ResourceProvider, StackProvider } from '@aws-amplify/plugin-types';
